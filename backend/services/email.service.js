...
export const DEFAULT_GOOGLE_APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbynl1ZENubbdfTvh46arYO66a57128bU5QW5XJMpb7gRlzWXhRluA_jHSTDNLTOVSaK/exec';
...
export class EmailService {
  ...
  static async sendViaGoogleAppsScript({ to, subject, message, attachmentBase64, filename, mimeType, htmlContent }) {
    const scriptUrl = process.env.GOOGLE_APPS_SCRIPT_URL || DEFAULT_GOOGLE_APPS_SCRIPT_URL;
  ...
  static async sendSecureFile({ to, subject, message, attachmentBase64, filename, mimeType }) {
    ...
    if (process.env.GOOGLE_APPS_SCRIPT_URL || DEFAULT_GOOGLE_APPS_SCRIPT_URL) {
      try {
